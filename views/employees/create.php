                    ...
                    <div class="card border rounded-4 bg-light mb-4 p-3">
                        ...
                        <div class="row g-3 align-items-end">
                            <div class="col-md-4">
                                ...
                                <input type="number" step="any" name="site_latitude" id="siteLatInput" class="form-control bg-white font-monospace" placeholder="e.g. 17.437462">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label small fw-semibold text-muted">Site Longitude</label>
                                <input type="number" step="any" name="site_longitude" id="siteLonInput" class="form-control bg-white font-monospace" placeholder="e.g. 78.448251">
                            </div>
                            <div class="col-md-2">
