                    ...
                    <div class="card border rounded-4 bg-light mb-4 p-3">
                        ...
                        <div class="row g-3 align-items-end">
                            <div class="col-md-4">
                                ...
                                <input type="number" step="any" name="site_latitude" id="siteLatInput" class="form-control bg-white font-monospace fw-bold text-dark" placeholder="e.g. 17.428990" onpaste="handleDirectCoordPaste(event)" oninput="handleManualCoordChange()">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label small fw-semibold text-muted">Site Longitude <span class="text-danger">*</span></label>
                                <input type="number" step="any" name="site_longitude" id="siteLonInput" class="form-control bg-white font-monospace fw-bold text-dark" placeholder="e.g. 78.454556" onpaste="handleDirectCoordPaste(event)" oninput="handleManualCoordChange()">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label small fw-semibold text-muted">Allowed Radius (Meters)</label>
                                <div class="input-group">
                                    <input type="number" name="site_radius" id="siteRadiusInput" class="form-control bg-white font-monospace fw-bold" value="200" min="10" max="5000" oninput="updateMapCircleRadius(this.value)">
...
<script>
    ...
    function updateUrlPreview(code) {
        ...
        if (trimmed) {
            const base = '<?= base_url("p/") ?>';
            preview.value = base + encodeURIComponent(trimmed);
        }
    }
